(this.wordle = this.wordle || {}),
	(this.wordle.bundle = (function (e) {
			...
			return (
				...
				(function (e, a) {
					...
					try {
						for (
							s = s.call(e);
							!(r = (t = s.next()).done) && (n.push(t.value), !a || n.length !== a);
							r = !0
						);
					} catch (e) {
						(i = !0), (o = e);
        ...
        /*------------------------------------------*/
        /* See Stylesheet: Starting Game Grid Tiles */
        /*------------------------------------------*/
									...
									this.$tile.addEventListener("animationend", function (a) {
										"PopIn" === a.animationName && (e._animation = "idle"),
											"FlipIn" === a.animationName &&
												((e.$tile.dataset.state = e._state), (e._animation = "flip-out")),
        ...
        /*---------------------------------------------*/
        /* See Stylesheet: Row tiles and win animation */
        /*---------------------------------------------*/
						...
						n = ka.length > 3 && "function" == typeof n ? (o--, n) : void 0,
							r &&
								(function (e, s, t) {
									...
									var o = a(s);
									return (
										!!("number" == o ? Re(t) && ta(s, t.length) : "string" == o && (s in t)) &&
										q(t[s], e)
									);
								})(s[0], s[1], r) &&
								((n = o < 3 ? void 0 : n), (o = 1)),
        ...
        /*----------------------------------------------------------------*/
        /* See Stylesheet: Settings Modal (hard, dark, color blind modes) */
        /*----------------------------------------------------------------*/
        ...
        <div class="sections">
            <section>
                <div class="setting">
                    <div class="text">
                        ...
                        <div class="description">Revealed hints must be in subsequent guesses</div>
                    </div>
                    <div class="control">
                ...
                <div class="setting">
                    <div class="text">
                        <div class="setting-title">Color Blind Mode</div>
            ...
            <section>
                <div class="setting">
                    ...
                    <div class="control"> <a href="https://github.com/emjose/wordle-2/#header" target="_blank" rel="noopener noreferrer" title="Github Repo">Repo</a> </div>
                </div>
            </section>
            <section>
                <div class="setting">
                    <div class="text">
                        <div class="setting-title">Emmanuel Jose</div>
                    </div>
                    <div class="control"> <a href="https://www.emmanuel-jose.com/" target="_blank" rel="noopener noreferrer" title="Portfolio">Portfolio</a> | <a href="https://www.linkedin.com/in/emmanuelpjose/" target="_blank" rel="noopener noreferrer" title="LinkedIn">LinkedIn</a></div>
                </div>
            </section>
        </div>
        <div id="footnote">
            <div>
                <div id="privacy-policy" ><a href="https://www.powerlanguage.co.uk/privacy-policy.html" target="_blank" rel="noopener noreferrer">Privacy Policy</a></div>
                <div id="copyright">Support and play the <a href="https://www.nytimes.com/games/wordle/index.html" target="_blank" rel="noopener noreferrer" title="Wordle">official Wordle game!</a> </div>
                <div id="copyright">The Wordle 2 demo is made for educational purposes only.</div>
                <div id="copyright">Copyright 2021-2022. <a href="https://www.powerlanguage.co.uk/" target="_blank" rel="noopener noreferrer" title="Josh Wardle">© Josh Wardle  © Powerlanguage.</a>  All Rights Reserved.</div>
            </div>
            <div> </div>
        </div>`;
        ...
        /*--------------------------------------------*/
        /* See Stylesheet: Toast window notifications */
        /*--------------------------------------------*/
		...
		function Va(e) {
			var a = e.isWin,
				...
				o = Xa();
			a
				? ((o.guesses[t] += 1), s ? (o.currentStreak += 1) : (o.currentStreak = 1))
        ...
        /*-----------------------------------------------*/
        /* See Stylesheet: Header, title, and game board */
        /*-----------------------------------------------*/
		...
		Ka.innerHTML = `
            ...
            #game-toaster {
                z-index: `
			.concat(1e3, ";   }   #system-toaster {     z-index: ")
			.concat(
				4e3,
				`;
            }
		...
		var Qa = document.createElement("template");
		Qa.innerHTML = `
        <button id="reveal" aria-label="reveal animation">reveal</button>
            <button id="shake" aria-label="shake animation">shake</button>
            <button id="bounce" aria-label="bounce animation">bounce</button>
			...
			ts = (function (e) {
				...
				function t() {
					...
					return (
						...
						!e.lastPlayedTs || o.gameStatus !== "IN_PROGRESS"
							...
							value: function () {
								...
								this.$game.addEventListener("game-key-press", function (a) {
									...
									"←" === s || "Backspace" === s
										...
										: "↵" === s || "Enter" === s
										? e.submitGuess()
										: Ba.includes(s.toLowerCase()) && e.addLetter(s.toLowerCase());
								}),
        ...
        /*----------------------------------*/
        /* See Stylesheet: Statistics modal */
        /*----------------------------------*/
        ...
        <div class="overlay">
            <div class="stats-content">
                <slot></slot>
                <div class="stats-close-icon">
                    <game-icon id="stats-icon" icon="close"></game-icon>
                </div>
            </div>
        </div>`
		);
						...
						value: function () {
							...
							this.shadowRoot.appendChild(os.content.cloneNode(!0)),
								this.addEventListener("click", function (a) {
									e.shadowRoot.querySelector(".stats-content").classList.add("closing");
								}),
								this.shadowRoot.addEventListener("animationend", function (a) {
									"SlideOut" === a.animationName &&
										(e.shadowRoot.querySelector(".stats-content").classList.remove("closing"),
        ...
        /*-------------------------------------*/
        /* See Stylesheet: The bottom keyboard */
        /*-------------------------------------*/
		...
		is.innerHTML = `<button id="key-button" aria-label="keyboard key">key</button>`;
							...
							value: function () {
								...
								this.shadowRoot.appendChild(rs.content.cloneNode(!0)),
									...
									this.$keyboard.addEventListener("click", function (a) {
										var s = a.target.closest("button#key-button");
									...
									window.addEventListener("keydown", function (a) {
										if (!0 !== a.repeat) {
											...
											t ||
												o ||
												((Ba.includes(s.toLowerCase()) || "Backspace" === s || "Enter" === s) &&
									...
									ds.forEach(function (a) {
										...
										s.classList.add("keyboard-row"),
											a.forEach(function (e) {
												var a;
												if ((e >= "a" && e <= "z") || "←" === e || "↵" === e) {
													if (
														(((a = is.content.cloneNode(!0).firstElementChild).dataset.key =
															e),
														(a.textContent = e),
														"←" === e)
													) {
													...
													"↵" == e &&
														((a.textContent = "enter"), a.classList.add("one-and-a-half"));
      ...
      ***************************************************************************** */
        ...
        /*-----------------------------------------------*/
        /* See Stylesheet: Statistics data and bar graph */
        /*-----------------------------------------------*/
        ...
        <div class="stats-modal-container">
            <h1 id="stats-modal-title">Statistics</h1>
            <div id="statistics"></div>
            <h1 id="stats-modal-title">Guess Distribution</h1>
		...
		var Is = document.createElement("template");
		Is.innerHTML = `
        <div style="display: flex; width: 50%; place-content: center;">
            <button id="retry-button" onclick="window.location.reload();" aria-label="new game"> New Game </button>
        </div>`;
		var Ms = {
					...
					o(t, [
						{
							...
							value: function () {
								...
								if (
									(["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach(function (
										s
									) {
										var t = Ms[s],
											o = e.stats[s],
									...
									var p = this.shadowRoot.querySelector(".stats-footer"),
										m = Is.content.cloneNode(!0);
									p.appendChild(m),
										this.shadowRoot
											.querySelector("button#retry-button")
											.addEventListener("click", function (a) {
        ...
        /*----------------------------------------------*/
        /* See Stylesheet: Settings modal: toggle knobs */
        /*----------------------------------------------*/
        ...
        <div class="toggle-container">
            ...
            <div class="switch"> <span class="knob"></div>
            </div></div>`;
		var Ps = (function (e) {
			r(t, e);
			var a = h(t);
					...
					[
						{
							...
							value: function () {
								var e = this;
								this.shadowRoot.appendChild(Rs.content.cloneNode(!0)),
									this.shadowRoot.querySelector(".toggle-container").addEventListener("click", function (a) {
										a.stopPropagation(),
        ...
        /*------------------------------------------------*/
        /* See Stylesheet: Game help / instructions modal */
        /*------------------------------------------------*/
        ...
        <section>
            <div class="instructions">
                ...
                <p>• Each guess must be a valid 5 letter word. Hit enter.</p>
                <p>• The tile's color indicates accuracy of guess.</p>
                <div class="examples">
                    <p id="example-title"><strong>Examples</strong></p>
                    <div class="example">
                        <div class="instruction-row">
                            <game-tile id="intro" letter="g" evaluation="correct" reveal></game-tile>
                            <game-tile id="intro" letter="r"></game-tile>
                            <game-tile id="intro" letter="e"></game-tile>
                            <game-tile id="intro" letter="a"></game-tile>
                            <game-tile id="intro" letter="t"></game-tile>
                        </div>
                        <p>The letter <strong>G</strong> is in the word and in the correct spot.</p>
                    </div>
                    <div class="example">
                        <div class="instruction-row">
                            <game-tile id="intro" letter="m"></game-tile>
                            <game-tile id="intro" letter="i" evaluation="present" reveal></game-tile>
                            <game-tile id="intro" letter="n"></game-tile>
                            <game-tile id="intro" letter="d"></game-tile>
                            <game-tile id="intro" letter="s"></game-tile>
                        </div>
                        <p>The letter <strong>I</strong> is in the word but in the wrong spot.</p>
                    </div>
                    <div class="example">
                        <div class="instruction-row">
                            <game-tile id="intro" letter="f"></game-tile>
                            <game-tile id="intro" letter="o"></game-tile>
                            <game-tile id="intro" letter="c"></game-tile>
                            <game-tile id="intro" letter="u" evaluation="absent" reveal></game-tile>
                            <game-tile id="intro" letter="s"></game-tile>
                        </div>
                        <p>The letter <strong>U</strong> is not in the word in any spot.</p>
                    </div>
                </div>
                <p id="play-footnote"><span>Wordle 2</span> - play as much as you want!</p>     
            </div>   
        </section>`;
		var Hs = (function (e) {
			r(t, e);
        ...
        /*-----------------------------------------------------------------------------*/
        /* See Stylesheet: Overlay for the header modals: "How to Play" and "Settings" */
        /*-----------------------------------------------------------------------------*/
        ...
        <div class="overlay">
            <div class="content">
                <header id="overlay-header">
                    <h1 id="overlay-header-title"><slot></slot></h1>
		...
		Gs.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"> <path fill=var(--color-tone-2) /> </svg>`;
		var Bs = {
